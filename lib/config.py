...
__C.DATA_PATH = '/mnt/beegfs/gpu/argoverse-tracking-all-training/argo/training'
__C.VAL_DATA_PATH = '/mnt/beegfs/gpu/argoverse-tracking-all-training/argo/validation'
...
__C.PC_AREA_SCOPE = np.array([[-100, 100],
                              [-3,   3],
                              [-100, 100]])  # x, y, z scope in rect camera coords
